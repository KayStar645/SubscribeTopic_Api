...
{
    public class DetailJobRequestHandler : IRequestHandler<DetailJobRequest, Result<JobDto>>
    {
        private readonly IMapper _mapper;
        private readonly IUnitOfWork _unitOfWork;

        public DetailJobRequestHandler(IUnitOfWork unitOfWork, IMapper mapper)
        {
            _mapper = mapper;
