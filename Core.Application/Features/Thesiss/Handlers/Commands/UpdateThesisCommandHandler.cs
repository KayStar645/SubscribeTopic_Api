            ...
            try
            {
                ...
                await Task.Run(async () =>
                {
                    using (var scope = _serviceProvider.CreateScope())
                    {
                        ...
                        await mediator.Publish(new AfterUpdateThesisCreateOrUpdateThesisInstructionsEvent(request.updateThesisDto, thesisDto, unitOfWork, httpContext));
                        await mediator.Publish(new AfterUpdateThesisCreateOrUpdateThesisReviewsEvent(request.updateThesisDto, thesisDto, unitOfWork, httpContext));
